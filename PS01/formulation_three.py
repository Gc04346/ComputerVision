...
class FormulationThree:
    ...
    def b():
        ...
        grass_frequency_back = Utils.get_complex_from_polar(grass_frequency_polar)
        ...
        for complex_group in night_sky_frequency_polar:
            ...
            complex_group[0] = transformed_coords
        night_sky_frequency_back = Utils.get_complex_from_polar(night_sky_frequency_polar)
        ...
        for complex_group in tulips_frequency_polar:
            ...
            complex_group[0] = transformed_coords
        tulips_frequency_back = Utils.get_complex_from_polar(tulips_frequency_polar)
        ...
        for complex_group in water_frequency_polar:
            ...
            complex_group[0] = transformed_coords
        water_frequency_back = Utils.get_complex_from_polar(water_frequency_polar)

        grass_back = Utils.get_image_in_spatial_domain(grass_frequency_back)
        night_sky_back = Utils.get_image_in_spatial_domain(night_sky_frequency_back)
        tulips_back = Utils.get_image_in_spatial_domain(tulips_frequency_back)
        water_back = Utils.get_image_in_spatial_domain(water_frequency_back)
